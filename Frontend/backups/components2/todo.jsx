...
function Todo(){
    ...
    const getTodo = async()=>{
        try{
            setLoading(true);
            setError("");
            const response = await axios.get(`${backendurl}/todo`, {headers:{Authorization:`Bearer ${token}`}});
    ...
    const addTodo = async(e)=> {
        ...
        try{
            setError("");
            await axios.post(`${backendurl}/todo`, {title:title},{headers:{Authorization:`Bearer ${token}`}});
            setTitle("");
            getTodo();
        }catch(error){
    ...
    const updateTask = async(id)=>{
        try{
            setError("");
            await axios.put(`${backendurl}/todo/${id}`, {title:editTitle},{headers:{Authorization:`Bearer ${token}`}});
            setEditID(null);
            setEditTitle("");
            getTodo();
        }catch(error){
    ...
    const toogleTodo = async(todo)=>{
        try{
            setError("");
            await axios.put(`${backendurl}/todo/${todo._id}`, {completed:!todo.completed},{headers:{Authorization:`Bearer ${token}`}});
            getTodo();
        }catch(error){
    ...
    const deleteTodo = async(id) =>{
        try{
            setError("");
            await axios.delete(`${backendurl}/todo/${id}`,{headers:{Authorization:`Bearer ${token}`}});
            getTodo();
        }catch(error){
